...
def main() -> None:
  ...
  if total_cells <= 4000:
    ...
    print(f"DP matrix size: {len(x) + 1} x {len(y) + 1} ({total_cells} cells)")
    print("Skipping full matrix/path printout to avoid huge terminal output.")
  ...
  plot_dp_matrix(
    ...
    y,
    path,
    title="Weighted Global Alignment DP Matrix",
